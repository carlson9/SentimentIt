...
test_that("Proper inputs for fitStanHier", {
  ...
  expect_error(fitStanHier(wrong_data, correct_hier_data, "col1"), "data dimension mismatches")

  expect_error(fitStanHier(correct_data, correct_hier_data, "col_wr"),
...
test_that("Outout for fitStanHier is class rstan",{
  ...
  expect_true(class(fitStanHier(data=ExampleData_hier1, hierarchy_data=ExampleData_hier2, hierarchy_var="countries"))=="stanfit")
})
