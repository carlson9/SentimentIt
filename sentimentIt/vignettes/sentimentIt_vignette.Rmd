...
Check the status of batches in Mechanical Turk
------

Once you have submitted batches of comparisons to Mechanical Turk, you can check thier status to see how many comparisons in the batch have been completed. This can be done using the `checkBatches()` function. To check the status of a batch, all you need is the batch ID number.
