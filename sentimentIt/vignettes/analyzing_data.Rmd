...
The `fitStan()` function outputs an object of class "stanfit" containing estimates for the position on the latent scale of interest for each object of comparison from the data as well as each workers reliability.
